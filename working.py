...
# @Last Modified time: 2025-02-06 05:41:46
import torch
...
cond = generate_grid_edges(4,6)
batchsize = 4 * 6

# grid structure
xt = torch.randn([1, batchsize, 2]) 
*xt, x0 = samples(model, schedule.sample_sigmas(120), gam=2, cond=cond, batchsize=batchsize,xt = xt)
