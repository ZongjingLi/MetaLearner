...
class GlobalContext:
    """Global context manager for constant evaluation"""
    _eval_context = {}
    
    @classmethod
    def set_context(cls, context):
        cls._eval_context = context
        
    @classmethod
    def get_context(cls):
        if cls._eval_context is None:
            raise ValueError("No evaluation context set")
        return cls._eval_context
