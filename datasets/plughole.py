...
class ShapeSortingDatasetGenerator:
    def __init__(self, output_dir="data/shape_sorting_dataset", num_samples=1000):
        """
...
def main():
    ...
    parser.add_argument('--dataset_dir', type=str, default='data/shape_sorting_dataset', help='Dataset directory')
